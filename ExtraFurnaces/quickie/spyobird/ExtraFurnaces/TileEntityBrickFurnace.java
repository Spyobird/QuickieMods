...
public class TileEntityBrickFurnace extends TileEntity implements ISidedInventory
{
    ...
    {
        return this.isInvNameLocalized() ? this.field_94130_e : "BrickFurnace";
    }
    ...
    public void updateEntity()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                flag1 = true;
                BlockFurnaceBrick.updateFurnaceBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            }
        }
    ...
    private boolean canSmelt()
    {
        ...
        {
            ItemStack itemstack = BrickFurnaceRecipes.smelting().getSmeltingResult(this.furnaceItemStacks[0]);
